...
@Singleton
@AutoBind
public class JacksonSubTypeIdsVersionedFeatures implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsVersionedFeatures() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(VersionedFeaturesConfiguration.class)
            .id(
                ExtensionConfiguration.getBuildingBlockIdentifier(
                    VersionedFeaturesConfiguration.class))
            .build());
  }
}
