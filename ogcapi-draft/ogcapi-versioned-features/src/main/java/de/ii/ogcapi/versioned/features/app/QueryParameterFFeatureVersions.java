...
@Singleton
@AutoBind
public class QueryParameterFFeatureVersions extends QueryParameterF {

  @Inject
  public QueryParameterFFeatureVersions(
  ...
  protected Class<? extends FormatExtension> getFormatClass() {
    return TimeMapFormatExtension.class;
  }
