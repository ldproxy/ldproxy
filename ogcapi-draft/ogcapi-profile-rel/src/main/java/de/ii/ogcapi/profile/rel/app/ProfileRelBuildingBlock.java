 ...
 * @conformanceEn *Profile -Relationships* implements the Rquirements Class "Profiles for feature
 *     references" [draft of OGC API - Features - Part 5:
 *     Schemas](https://docs.ogc.org/DRAFTS/23-058r1.html).
 * @conformanceDe Der Baustein implementiert die Requirements Class "Profiles for feature
 *     references" [Entwurf von OGC API - Features - Part 5:
 *     Schemas](https://docs.ogc.org/DRAFTS/23-058r1.html).
