...
@Singleton
@AutoBind
public class JacksonSubTypeIdsProfileRel implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsProfileRel() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(ProfileRelConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(ProfileRelConfiguration.class))
            .build());
  }
}
