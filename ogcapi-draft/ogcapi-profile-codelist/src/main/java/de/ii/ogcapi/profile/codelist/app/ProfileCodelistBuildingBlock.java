 ...
 * </code>
 * @scopeDe Eine Codeliste ist eine Liste von Codes mit einem von Menschen lesbaren Titel. Zwei
 *     verschiedene Darstellungen einer codelist-bewerteten Eigenschaft in einem Schema werden als
 *     Profile unterstützt. Die beiden Profile sind:
 *     <p><code>
 * - "codelist-inline": Das Schema jeder codelist-bewerteten Eigenschaft wird durch ein "oneOf"-Schema mit einem Schema für jeden Code dargestellt. Das Schema für jeden Code hat ein "const"-Mitglied mit dem Code als Wert. Diese Darstellung hat den Vorteil, dass alle Informationen im Schema enthalten sind; es muss nicht auf externe Informationen zugegriffen werden.
...
@Singleton
@AutoBind
public class ProfileCodelistBuildingBlock implements ApiBuildingBlock {
