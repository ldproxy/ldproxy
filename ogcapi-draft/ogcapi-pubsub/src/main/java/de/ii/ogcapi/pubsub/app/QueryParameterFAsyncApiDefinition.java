...
@Singleton
@AutoBind
public class QueryParameterFAsyncApiDefinition extends QueryParameterF {

  @Inject
  public QueryParameterFAsyncApiDefinition(
  ...
  protected Class<? extends FormatExtension> getFormatClass() {
    return AsyncApiDefinitionFormatExtension.class;
  }
