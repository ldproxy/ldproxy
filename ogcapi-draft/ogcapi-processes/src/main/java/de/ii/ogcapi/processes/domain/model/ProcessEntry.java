...
public abstract class ProcessEntry extends ProcessSummaryEntry implements Process {

  public static final String SCHEMA_REF = "#/components/schemas/Process";

  // ToDo Add Input / Outputs once implemented
  @SuppressWarnings("UnstableApiUsage")
  public static final Funnel<ProcessEntry> FUNNEL = ProcessSummaryEntry.FUNNEL::funnel;
