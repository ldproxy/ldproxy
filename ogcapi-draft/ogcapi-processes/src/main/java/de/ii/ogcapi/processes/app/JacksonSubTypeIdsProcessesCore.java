...
@Singleton
@AutoBind
public class JacksonSubTypeIdsProcessesCore implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsProcessesCore() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(ProcessesCoreConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(ProcessesCoreConfiguration.class))
            .build());
  }
}
