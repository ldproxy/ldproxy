...
@Singleton
@AutoBind
public class QueryParameterFProcess extends QueryParameterF {

  @Inject
  public QueryParameterFProcess(
  ...
  public boolean matchesPath(String definitionPath) {
    return "/processes/{processId}".equals(definitionPath);
  }

  @Override
  protected Class<? extends FormatExtension> getFormatClass() {
    return ProcessFormatExtension.class;
  }
