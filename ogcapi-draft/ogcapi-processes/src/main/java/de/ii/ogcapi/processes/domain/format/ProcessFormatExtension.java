...
@AutoMultiBind
public interface ProcessFormatExtension extends GenericFormatExtension {

  Object getEntity(ProcessResponse processResponse, OgcApi api, ApiRequestContext requestContext);
}
