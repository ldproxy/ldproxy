...
export const normalizeCrs = (crs: string | undefined | null, fallback: string = DEFAULT_CRS_URI): string => {
  if (!crs) {
    return fallback;
  }
...
export const toCanonicalCrsUri = (crs: string | undefined | null): string => {
...
export const getDefaultCollectionCrs = (crsValues: string[] | undefined): string => {
