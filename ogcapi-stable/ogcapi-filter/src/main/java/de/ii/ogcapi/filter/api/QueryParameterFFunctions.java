...
@Singleton
@AutoBind
public class QueryParameterFFunctions extends QueryParameterF {

  @Inject
  public QueryParameterFFunctions(
  ...
  public boolean matchesPath(String definitionPath) {
    return "/functions".equals(definitionPath);
  }

  @Override
  protected Class<? extends FormatExtension> getFormatClass() {
    return FunctionsFormatExtension.class;
  }
