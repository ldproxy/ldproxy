 ...
 *     of [JSON-FG 1.0.0](https://docs.ogc.org/is/21-045r1/21-045r1.html).
 ...
 *     1.0.0](https://docs.ogc.org/is/21-045r1/21-045r1.html).
...
public class JsonFgBuildingBlock implements ApiBuildingBlock, ConformanceClass {
  ...
  public List<String> getConformanceClassUris(OgcApiDataV2 apiData) {
    return List.of("http://www.opengis.net/spec/json-fg-1/1.0/conf/api");
  }
}
