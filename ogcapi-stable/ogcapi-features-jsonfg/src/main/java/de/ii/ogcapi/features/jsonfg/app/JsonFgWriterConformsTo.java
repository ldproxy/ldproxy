...
public class JsonFgWriterConformsTo implements GeoJsonWriter {
  ...
  public static String URI_CORE = "http://www.opengis.net/spec/json-fg-1/1.0/conf/core";
  public static String URI_POLYHEDRA = "http://www.opengis.net/spec/json-fg-1/1.0/conf/polyhedra";
  public static String URI_CIRCULAR_ARCS =
      "http://www.opengis.net/spec/json-fg-1/1.0/conf/circular-arcs";
  public static String URI_TYPE = "http://www.opengis.net/spec/json-fg-1/1.0/conf/types-schemas";
  public static String URI_PROFILES = "http://www.opengis.net/spec/json-fg-1/1.0/conf/profiles";
