...
@Singleton
@AutoBind
public class QueryParameterProfileQueryables extends QueryParameterProfile
    implements ConformanceClass {

  @Inject
  public QueryParameterProfileQueryables(
  ...
  public String getId(String collectionId) {
    return "profileQueryables_" + collectionId;
  }
