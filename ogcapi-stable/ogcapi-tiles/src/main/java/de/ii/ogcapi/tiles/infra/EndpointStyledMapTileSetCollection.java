 ...
 * @langEn Access collection map tileset in a specific style.
 * @langDe Zugriff auf einen Rasterkachelsatz einer Feature Collection in einem bestimmten Style.
 * @ref:formats {@link de.ii.ogcapi.tiles.domain.TileSetFormatExtension}
 */
@Singleton
@AutoBind
public class EndpointStyledMapTileSetCollection extends AbstractEndpointTileSetCollection
    implements ConformanceClass, ApiExtensionHealth {

  private static final List<String> TAGS = ImmutableList.of("Access map tiles");

  @Inject
  EndpointStyledMapTileSetCollection(
