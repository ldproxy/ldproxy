 ...
 * @langDe Zugriff auf Rasterkachelsätze einer Feature Collection
 * @ref:formats {@link de.ii.ogcapi.tiles.domain.TileSetsFormatExtension}
 */
@Singleton
@AutoBind
public class EndpointMapTileSetsCollection extends AbstractEndpointTileSetsCollection
    implements ConformanceClass, ApiExtensionHealth {

  private static final Logger LOGGER = LoggerFactory.getLogger(EndpointMapTileSetsCollection.class);

  private static final List<String> TAGS = ImmutableList.of("Access map tiles");

  @Inject
  EndpointMapTileSetsCollection(
  ...
  protected ApiEndpointDefinition computeDefinition(OgcApiDataV2 apiData) {
    return computeDefinition(
        ...
        "/map/tiles",
        getOperationId(
            "getTileSetsList", EndpointTileMixin.COLLECTION_ID_PLACEHOLDER, "collection", "map"),
        TAGS);
  }
