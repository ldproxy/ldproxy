...
@Singleton
@AutoBind
public class JacksonSubTypeIdsProfileCodelist implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsProfileCodelist() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(ProfileCodelistConfiguration.class)
            .id(
                ExtensionConfiguration.getBuildingBlockIdentifier(
                    ProfileCodelistConfiguration.class))
            .build());
  }
}
