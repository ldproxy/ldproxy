 ...
 * </code>
 * @conformanceEn *Profile -Codelist* implements the Requirements Class "Profiles for codelists" of
 *     [OGC API - Features - Part 5/OGC API - Common - Part 3:
 *     Schemas](https://docs.ogc.org/is/23-058r2/23-058r2.html).
 * @conformanceDe Der Baustein implementiert die Requirements Class "Profiles for codelists" von
 *     [OGC API - Features - Part 5/OGC API - Common - Part 3:
 *     Schemas](https://docs.ogc.org/is/23-058r2/23-058r2.html).
...
public class ProfileCodelistBuildingBlock implements ApiBuildingBlock, ConformanceClass {
  ...
  public List<String> getConformanceClassUris(OgcApiDataV2 apiData) {
    return List.of("http://www.opengis.net/spec/ogcapi-common-3/1.0/conf/profile-codelists");
  }
