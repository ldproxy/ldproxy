...
public class CollectionPropertiesQueriesHandlerImpl implements CollectionPropertiesQueriesHandler {
  ...
  public CollectionPropertiesQueriesHandlerImpl(
    ...
    this.queryHandlers =
        ImmutableMap.of(
            Query.COLLECTION_PROPERTIES,
            QueryHandler.with(
                QueryInputCollectionProperties.class, this::getCollectionPropertiesResponse));
  }
  ...
  private Response getCollectionPropertiesResponse(
      QueryInputCollectionProperties queryInput, ApiRequestContext requestContext) {
