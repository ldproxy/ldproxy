...
@Singleton
@AutoBind
public class JacksonSubTypeIdsResultType implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsResultType() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(ResultTypeConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(ResultTypeConfiguration.class))
            .build());
  }
}
