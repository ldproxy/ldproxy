...
@Singleton
@AutoBind
public class JacksonSubTypeIdsCodelists implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsCodelists() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(CodelistsConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(CodelistsConfiguration.class))
            .build());
  }
}
