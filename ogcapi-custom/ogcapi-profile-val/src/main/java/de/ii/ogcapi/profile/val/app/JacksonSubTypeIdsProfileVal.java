...
@Singleton
@AutoBind
public class JacksonSubTypeIdsProfileVal implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsProfileVal() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(ProfileValConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(ProfileValConfiguration.class))
            .build());
  }
}
