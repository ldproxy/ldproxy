 ...
 */
package de.ii.ogcapi.async.app.parameter;
...
@Singleton
@AutoBind
public class QueryParameterFStatusInfoAsync extends QueryParameterF {

  @Inject
  public QueryParameterFStatusInfoAsync(
  ...
  @Override
  public String getId() {
    return "fStatusInfoAsync";
  }

  @Override
  public boolean matchesPath(String definitionPath) {
    return "/jobs/{jobId}".equals(definitionPath);
  }
