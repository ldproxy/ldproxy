...
@Singleton
@AutoBind
public class JacksonSubTypeIdsProfileCrs implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsProfileCrs() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(ProfileCrsConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(ProfileCrsConfiguration.class))
            .build());
  }
}
