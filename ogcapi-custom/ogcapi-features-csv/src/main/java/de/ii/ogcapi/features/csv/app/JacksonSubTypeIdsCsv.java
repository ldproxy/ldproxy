...
@Singleton
@AutoBind
public class JacksonSubTypeIdsCsv implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsCsv() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(CsvConfiguration.class)
            .id(ExtensionConfiguration.getBuildingBlockIdentifier(CsvConfiguration.class))
            .build());
  }
}
