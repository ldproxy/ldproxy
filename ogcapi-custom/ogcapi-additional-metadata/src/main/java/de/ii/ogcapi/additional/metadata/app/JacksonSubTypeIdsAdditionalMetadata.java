...
@Singleton
@AutoBind
public class JacksonSubTypeIdsAdditionalMetadata implements JacksonSubTypeIds {

  @Inject
  public JacksonSubTypeIdsAdditionalMetadata() {}
  ...
  public List<JacksonSubType> getSubTypes() {
    return ImmutableList.of(
        ImmutableJacksonSubType.builder()
            ...
            .subType(AdditionalMetadataConfiguration.class)
            .id(
                ExtensionConfiguration.getBuildingBlockIdentifier(
                    AdditionalMetadataConfiguration.class))
            .build());
  }
}
